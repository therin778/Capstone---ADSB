...
debug_file = True # Outputs the contents of the output to the next file
...
for i in range(0,len(infile),block_size):
    ...
    messageBits = getMessages(sample_block) # Contains the message data as described in the ICD- decoding team, you guys process this data.
